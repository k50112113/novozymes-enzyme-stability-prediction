...
mutation_msd_map = {}
with open("res-com-msd-ratio-range-3d=%.2f.txt"%(res_cutoff),"r") as fin:
    fin.readline()
    for aline in fin:
        linelist = aline.strip().split()
...
foutrescom = open("submission-res-com-range-3d=%.2f.csv"%(res_cutoff),"w")
